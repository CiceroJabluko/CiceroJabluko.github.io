...
window.onload = function () {
  ...
  setTimeout(() => {
    ...
    const phrase1 =
      "So, um, I guess you wonder what’s next and where is some sort of game? ";
    const phrase2 =
      " I know, don't answer. Better tell me, did you like the song? Want to turn it back on?";
    const phrase3 =
      "Oh, I see, you're stuck! No worry, I'm going to render fancy buttons for you. A bit of CSS here and there. Here they are";
    const phrase4 = "Try pointing out on them. Aren't they beautiful?";
    const phrase8 = "So funny to have you here.";
    const phrase9 =
      "I mean, what brought you to such a vicious place on the world wide web must be really… ";
    ...
    yesButton.addEventListener("click", () => {
      ...
      setTimeout(() => {
        typeWriter(
          "Gorgeous, isn't it? I like this song so much too. ",
          phrase5Div
        );
      }, 4000);
      setTimeout(() => {
    ...
    noButton.addEventListener("click", () => {
      ...
      setTimeout(() => {
        typeWriter(
          "You must be joking. What do you want then? That stupid song you listened to recently?",
          phrase5Div,
          null,
          () => {
            setTimeout(() => {
              typeWriter(
                "I'll turn mine anyways. In the affair you got involved, my rules apply. And you've already neglected enough of them as of today.",
                phrase6Div,
                null,
                () => {
                  enableAudio();
  ...
  function spaceBarKeyDown(event) {
    if (event.code === "Space") {
      if (currentPhraseIndex >= phraseQueue.length) {
        ...
        window.location.href = "../page_3/page_3.html"; // Replace with the relative path to the next HTML document
        return;
      }
